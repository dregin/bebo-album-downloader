	...
	<body>
		<form action="confirm_test.php" method="post">
			<div id="container" style="align:center;border:1px solid black; padding:10px">
				...
				You must set your profile to public in order to use this app. You can set it back to private once you've been mailed the link to the zip :)
				<ul>
				...
				Download original (larger) images? <input type="checkbox" name="original"><br />
				<br>
